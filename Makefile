...
#    Updated: 2020/07/17 15:10:44 by tkitagaw         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
BONUS	=	ft_lstsize.c ft_lstnew.c ft_lstclear.c ft_lstdelone.c\
			ft_lstadd_front.c ft_lstadd_back.c ft_lstlast.c ft_lstiter.c ft_lstmap.c
OBJS	=	$(SRCS:.c=.o)
BOBJS	=	$(BONUS:.c=.o)
